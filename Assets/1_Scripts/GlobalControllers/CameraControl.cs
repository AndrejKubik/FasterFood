...
public class CameraControl : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        //}
        if (EmployeeManager.SpawnPoints[6].IsOccupied || EmployeeManager.SpawnPoints[5].IsOccupied)
        {
            cameras[0].Priority = 0;
            cameras[1].Priority = 0;
        ...
        else if (EmployeeManager.SpawnPoints[4].IsOccupied || EmployeeManager.SpawnPoints[3].IsOccupied)
        {
            cameras[0].Priority = 0;
